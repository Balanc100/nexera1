...
import { X, Save, Database, Copy, Check } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-slate-600 ml-8">
              สร้างไฟล์ Google Sheet ใหม่ในโฟลเดอร์ที่ต้องการแชร์ (หรือใช้ไฟล์เดิม) แล้วไปที่เมนู <strong>Extensions (ส่วนขยาย)</strong> {'>'} <strong>Apps Script</strong>
            </p>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="font-semibold text-slate-800 flex items-center gap-2">
              ...
              Deploy (ทำให้ใช้งานได้)
            </h3>
            <ul className="ml-8 list-disc list-outside text-sm text-slate-600 space-y-1 pl-4">
              <li>กดปุ่ม <strong>Deploy</strong> (สีฟ้ามุมขวาบน) {'>'} <strong>New deployment</strong></li>
              <li>เลือก type เป็น <strong>Web app</strong></li>
              <li>ช่อง <strong>Who has access</strong> เลือกเป็น <strong>Anyone (ทุกคน)</strong> *สำคัญ</li>
              <li>กด Deploy แล้วคัดลอก <strong>Web app URL</strong> มาวางด้านล่าง</li>
            </ul>
          </div>
          ...
          <div className="pt-4 border-t border-slate-100">
             <label className="block text-sm font-bold text-slate-700 mb-2">
               Web App URL (ที่ได้จากขั้นตอนที่ 3)
             </label>
             <input
               type="text"
               value={url}
               ...
               className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent font-mono text-sm bg-slate-50"
             />
          </div>
        </div>
